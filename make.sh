i686-elf-gcc -c src/kernel.c src/stdlib/tty.c src/stdlib/stdio/printf.c src/stdlib/stdio/putchar.c src/stdlib/stdio/puts.c src/stdlib/string/memcmp.c src/stdlib/string/memcpy.c src/stdlib/string/memmove.c src/stdlib/string/memset.c src/stdlib/string/strlen.c -std=gnu99 -ffreestanding -O2 -Wall -Wextra
